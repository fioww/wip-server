    ...
    partial class BehaviorDb
    {
        ...
        .Init("Turkey God",
            ...
            new Shoot(25, projectileIndex: 1, shootAngle: 10, count: 4, coolDown: 750)
                ...
                new MostDamagers(1,
                new ItemLoot("Ambrosia", .008)
                new ItemLoot("Chicken Leg of Doom", .002)
                ),
                new MostDamagers(2,
                new ItemLoot("Cranberries", 1),
                new ItemLoot("Ear of Corn", 0.5),
                new ItemLoot("Sliced Yam", 0.09),
                new ItemLoot("Pumpkin Pie", 0.05),
