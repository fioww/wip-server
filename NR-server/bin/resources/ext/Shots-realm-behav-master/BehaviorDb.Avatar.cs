        ...
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System",
                new State(
                  ...
                  new MostDamagers(3,
                        new ItemLoot("Tablet of the King's Avatar", 0.007) // Tiny Avatar Skin
                       ),
                      new MostDamagers(2,
                     new ItemLoot("Potion of Mana", 1)
                     ),
                     new MostDamagers(1,
                     new ItemLoot("Tiny Avatar Skin", 0.05)
                        ),
                    new TierLoot(12, ItemType.Armor, 0.09),
                    new TierLoot(5, ItemType.Ability, 0.08),
                    new TierLoot(11, ItemType.Armor, 0.010),
                    new TierLoot(11, ItemType.Weapon, 0.010),
                    new TierLoot(10, ItemType.Armor, 0.012),
                    new TierLoot(10, ItemType.Weapon, 0.012),
                    new TierLoot(9, ItemType.Armor, 0.014),
                    new TierLoot(9, ItemType.Weapon, 0.014)
            )
