...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("DS Goblin Peon",
            new State(
            new Wander(0.3),
            new Follow(1.6, 6, 2, coolDown: 500),
                new State("idle",
        ...
        .Init("ds Gulpord the Slime God",
            new State(
                ...
                new State("shoot",
                    ...
                    new AddCond(ConditionEffectIndex.Invulnerable, duration: 1500, coolDown: 5000),
                    new Shoot(10, 8, 45, 1, coolDown: 2000),
                    new Shoot(10, 5, 72, 0, 0, coolDown: 400, angleIncrease: 0.2f),
                    new Shoot(10, 5, 72, 0, 3, coolDown: 400, angleIncrease: 0.2f)
                    ),
                new State("randomshooting",
                    new AddCond(ConditionEffectIndex.Invulnerable, duration: 1500, coolDown: 5000),
                    new Shoot(10, 8, 360 / 8, 0, fixedAngle: 0, coolDown: 300, angleIncrease: 0.5f),
                ...
                new Follow(0.6, 10, 0),
                    new State("xdshoot",
                        new Shoot(10, 2, 10, 0, coolDown: 150, shootAngleIncrease: 0.1f)
                        )
                    )
                )
            //    ),
