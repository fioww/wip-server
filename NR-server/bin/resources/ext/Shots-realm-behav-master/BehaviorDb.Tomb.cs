        ...
        private _ Tomb = () => Behav()
            .Init("Tomb Defender",
                new State(
                    ...
                    new Threshold(0.16,
                        new ItemLoot("Ring of the Pyramid", 0.012), 
                        new ItemLoot("Tome of Holy Protection", 0.005),
                        new ItemLoot("Tome of Frigid Protection", 0.006),
                        new ItemLoot("Wine Cellar Incantation", 0.009)
                    ),
                    new Threshold(0.2
                    )
            )
             .Init("Tomb Support",
                                new State(
                                        ...
                                        new State("2Phase1",
                                                ...
                                                new SpecificHeal(1, 1500, "Tomb Bosses", 15000),
                                        ...
                                        new State("2Phase3",
                                                ...
                                                new SpecificHeal(1, 2000, "Tomb Bosses", 15000),
                                                new Shoot(16, count: 1, projectileIndex: 6, coolDown: 3000),
                                                new Shoot(32, count: 1, projectileIndex: 5, coolDown: 1000),
                                                new HpLessTransition(0.92, "2Phase4")
                                        ),
                                        new State("2Phase4",
                        new State("2Phase4 attack",
                            new Orbit(0.4, 3, 20, "Tomb Boss Anchor"),
                            new SpecificHeal(1, 1500, "Tomb Bosses", 15000),
                            new Shoot(16, count: 1, projectileIndex: 6, coolDown: 3000),
                            new Shoot(32, count: 1, projectileIndex: 5, coolDown: 1000),
                            new Shoot(16, count: 3, shootAngle: 360 / 3, projectileIndex: 1, coolDown: 2000),
                            new Shoot(16, count: 4, shootAngle: 360 / 4, projectileIndex: 2, coolDown: 3000),
                            new TimedTransition(60000, "2Phase4 broken")
                            ),
                        new State("2Phase4 broken",
                            new Orbit(0.8, 2, 20, "Tomb Boss Anchor"),
                            ...
                            new Shoot(16, count: 3, shootAngle: 360 / 3, projectileIndex: 1, coolDown: 2000),
                            new Shoot(16, count: 4, shootAngle: 360 / 4, projectileIndex: 2, coolDown: 3000),
                            new TimedTransition(20000, "2Phase4 attack")
                            ),
                                                new HpLessTransition(0.80, "2Phase5")
                                        ),
                                        new State("2Phase5",
                        new State("2Phase5 attack",
                            new Orbit(0.4, 3, 20, "Tomb Boss Anchor"),
                            new Shoot(16, count: 1, projectileIndex: 6, coolDown: 3000),
                            new Shoot(32, count: 1, projectileIndex: 5, coolDown: 1000),
                            new Shoot(16, count: 3, shootAngle: 360 / 3, projectileIndex: 1, coolDown: 2700),
                            ...
                            new Shoot(16, count: 6, shootAngle: 360 / 6, projectileIndex: 4, coolDown: 2000),
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new TimedTransition(60000, "2Phase5 broken")
                            ),
                        new State("2Phase5 broken",
                            new ConditionalEffect(ConditionEffectIndex.ArmorBroken),
                            new Orbit(0.8, 2, 20, "Tomb Boss Anchor"),
                            new Shoot(16, count: 1, projectileIndex: 6, coolDown: 3000),
                            new Shoot(32, count: 1, projectileIndex: 5, coolDown: 1000),
                            ...
                            new Shoot(16, count: 6, shootAngle: 360 / 6, projectileIndex: 4, coolDown: 2000),
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new TimedTransition(20000, "2Phase5 attack")
                            ),
                                                new HpLessTransition(0.60, "2Phase6")
                                        ),
                                        new State("2Phase6",
                        new State("2Phase6 attack",
                            ...
                            new TimedTransition(60000, "2Phase6 broken")
                            ),
                        new State("2Phase6 broken",
                            new ConditionalEffect(ConditionEffectIndex.ArmorBroken),
                            new Orbit(0.8, 3, 20, "Tomb Boss Anchor"),
                            new Shoot(16, count: 1, projectileIndex: 6, coolDown: 2600),
                            new Shoot(32, count: 1, projectileIndex: 5, coolDown: 800),
                            new Shoot(16, count: 3, shootAngle: 360 / 3, projectileIndex: 1, coolDown: 2700),
                            new Shoot(16, count: 4, shootAngle: 360 / 4, projectileIndex: 2, coolDown: 3000),
                            ...
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new Shoot(40, count: 4, fixedAngle: 140, shootAngle: 9, projectileIndex: 8, coolDown: 1000),
                            new TimedTransition(20000, "2Phase6 attack")
                            ),
                                                new HpLessTransition(0.50, "2Phase7")
                                        ),
                                        new State("2Phase7",
                        new State("2Phase7 attack",
                            new Taunt(0.99, "My artifacts shall make your lethargic lives end much more swiftly!"),
                            new Orbit(0.4, 3, 20, "Tomb Boss Anchor"),
                            new Spawn("Sphinx Artifact 1", 3, initialSpawn: 1),
                            new Spawn("Sphinx Artifact 2", 3, initialSpawn: 1),
                            ...
                            new Shoot(16, count: 6, shootAngle: 360 / 6, projectileIndex: 4, coolDown: 2000),
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new TimedTransition(60000, "2Phase7 broken")
                            ),
                        new State("2Phase7 broken",
                            new ConditionalEffect(ConditionEffectIndex.ArmorBroken),
                            new Taunt(0.99, "My artifacts shall make your lethargic lives end much more swiftly!"),
                            new Orbit(0.8, 2, 20, "Tomb Boss Anchor"),
                            new Spawn("Sphinx Artifact 1", 3, initialSpawn: 1),
                            ...
                            new Shoot(16, count: 6, shootAngle: 360 / 6, projectileIndex: 4, coolDown: 2000),
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new TimedTransition(20000, "2Phase7 attack")
                            ),
                                                new HpLessTransition(0.30, "2Phase8")
                                        ),
                                        new State("2Phase8",
                        new State("2Phase8 attack",
                            new Orbit(0.4, 3, 20, "Tomb Boss Anchor"),
                            new Spawn("Sphinx Artifact 1", 3, coolDown: 20000),
                            new Spawn("Sphinx Artifact 2", 3, coolDown: 20000),
                            new Spawn("Sphinx Artifact 3", 3, coolDown: 20000),
                            ...
                            new Shoot(16, count: 6, shootAngle: 360 / 6, projectileIndex: 4, coolDown: 2000),
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new TimedTransition(60000, "2Phase8 broken")
                            ),
                        new State("2Phase8 broken",
                            new ConditionalEffect(ConditionEffectIndex.ArmorBroken),
                            new Orbit(0.8, 2, 20, "Tomb Boss Anchor"),
                            new Spawn("Sphinx Artifact 1", 3, coolDown: 20000),
                            new Spawn("Sphinx Artifact 2", 3, coolDown: 20000),
                            ...
                            new Shoot(16, count: 6, shootAngle: 360 / 6, projectileIndex: 4, coolDown: 2000),
                            new Shoot(16, count: 5, shootAngle: 360 / 5, projectileIndex: 3, coolDown: 2500),
                            new TimedTransition(20000, "2Phase8 attack")
                            ),
                                                new HpLessTransition(0.10, "Rage")
                                        )
                                ),
                    ...
                    new MostDamagers(1,
                    new ItemLoot("Mini Nut Archer Skin", 0.04)
                    ),
                    new Threshold(0.16,
                        new ItemLoot("Ring of the Sphinx", 0.012),
             ...
             .Init("Tomb Attacker",
                                new State(
                                        ...
                                        new State("1Phase2",
                        new State("attack",
                            new TimedTransition(60000, "broken")
                            ),
                        new State("broken",
                            new ConditionalEffect(ConditionEffectIndex.ArmorBroken),
                ...
                new Threshold(0.16,
                    new ItemLoot("Ring of the Nile", 0.012),
             ...
             .Init("Jackal Lord",
                new State(
                    ...
                    new State("Chase",
                        ...
                        new InvisiToss("Jackal Warrior", 1, 180, coolDown: 9999999),
                        new InvisiToss("Jackal Veteran", 1, 90, coolDown: 9999999),
                        new InvisiToss("Jackal Assassin", 1, 0, coolDown: 9999999),
