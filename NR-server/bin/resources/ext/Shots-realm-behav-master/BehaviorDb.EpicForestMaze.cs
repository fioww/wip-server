...
namespace wServer.logic
{
    partial class BehaviorDb
    {
             ...
             new State(
                ...
                new MostDamagers(3,
                    new OnlyOne(
                        ...
                        new ItemLoot("Blade of the Forests", 0.008)
                        ),
                    ...
                    new TierLoot(4, ItemType.Ability, 0.7)
                )
            )
        .Init("Mini Larva",
            new State(
        ...
        .Init("Epic Mama Megamoth",
            new State(
                new HpLessTransition(0.15, "change"),
                new TransformOnDeath("Murderous Megamoth"),
                new State("idle",
                    new Wander(0.2),
                    new Follow(4.0, 10, coolDown: 0),
                    new Spawn("Woodland Mini Megamoth", coolDown: 1500, maxChildren: 10, initialSpawn: 3),
