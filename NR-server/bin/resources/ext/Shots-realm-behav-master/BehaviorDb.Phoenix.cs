    ...
    partial class BehaviorDb
    {
        private _ Phoenix = () => Behav()
            ...
            .Init("Phoenix Reborn",
                ...
                new ItemLoot("Staff of the Rising Sun", 0.001),
                new ItemLoot("Thousand Suns Spell", 0.001),
                new ItemLoot("Robe of the Summer Solstice", 0.001),
                new ItemLoot("Ring of the Burning Sun", 0.001)
            );
    }
}