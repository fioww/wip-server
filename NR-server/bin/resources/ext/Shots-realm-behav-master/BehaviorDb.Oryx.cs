            ...
            .Init("Oryx the Mad God 2",
                new State(
                    ...
                    new State("beforeRage",
                        ...
                        new Shoot(25, projectileIndex: 3, count: 2, shootAngle: 10, coolDown: 1000,coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 4, count: 3, shootAngle: 10, coolDown: 1000,coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 5, count: 2, shootAngle: 10, coolDown: 1000,coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 6, count: 3, shootAngle: 10, coolDown: 1000, coolDownOffset: 1000),
                        new Shoot(25, 30, fixedAngle: 0, projectileIndex: 7, coolDown: 4000, coolDownOffset: 4000),
                        new Shoot(25, 30, fixedAngle: 30, projectileIndex: 8, coolDown: 4000, coolDownOffset: 4000),
                    ...
                    new State("rage",
                        ...
                        new State("rageToss",
                            new TossObject("Monstrosity Scarab", 5, 0, coolDown: 1500),
                            new TossObject("Monstrosity Scarab", 5, 60, coolDown: 1500),
                            new TossObject("Monstrosity Scarab", 5, 120, coolDown: 1500),
                            new TossObject("Monstrosity Scarab", 5, 180, coolDown: 1500),
                            new TossObject("Monstrosity Scarab", 5, 240, coolDown: 1500),
                            new TossObject("Monstrosity Scarab", 5, 300, coolDown: 1500),
                ...
                new MostDamagers(10,
                    ...
                    new ItemLoot("Frost Drake Hide Armor", 0.01),
                    new ItemLoot("Frost Elementalist Robe", 0.01),
                    new ItemLoot("Frost Citadel Armor", 0.01)
                    ),
                new Threshold(0.001,
                    new TierLoot(13, ItemType.Weapon, 0.001),
                    new TierLoot(7, ItemType.Ability, 0.001),
                    new TierLoot(14, ItemType.Armor, 0.001)
                )
            )
        ...
        .Init("Abomination of Oryx",
            new State(
                new State("start",
                    ...
                    new Shoot(10, 5, 10, 1, coolDown: 4000, coolDownOffset: 100),
                    new Shoot(10, 7, 10, 2, coolDown: 5000, coolDownOffset: 200),
                    new Shoot(10, 5, 10, 3, coolDown: 6000, coolDownOffset: 300),
                    new Shoot(10, 3, 10, 4, coolDown: 7000, coolDownOffset: 400)
                    )
                )
            )
