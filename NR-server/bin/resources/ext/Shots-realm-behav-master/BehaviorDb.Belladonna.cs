    ...
    partial class BehaviorDb
    {
        ...
        private _ Belladonna = () => Behav()
            ...
            .Init("vlntns Loot Balloon Bella",
                ...
                new MostDamagers(4,
                    new OnlyOne(
                        new ItemLoot("Bashing Bride Skin", 0.08),
                        new ItemLoot("Eligible Bachelor Skin", 0.07)
                        ),
                    new ItemLoot("Diamond Bladed Katana", 0.8),
                    new ItemLoot("Cupid's Bow", 0.7),
                    new ItemLoot("Staff of Adoration", 0.8),
                    new ItemLoot("Wand of Budding Romance", 0.7),
                    new ItemLoot("Heartfind Dagger", 0.8),
                    new ItemLoot("Vinesword", 0.7)
                    )
            );
    }
}
