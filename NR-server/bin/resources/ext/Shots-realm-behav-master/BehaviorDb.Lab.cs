    ...
    partial class BehaviorDb
    {
        ...
        //Time to start that swaggy Dr Terribro HUAHAUHAUHAHAUQAGA
             .Init("Dr Terrible",
                ...
                new MostDamagers(3,
                    new OnlyOne(
                        new ItemLoot("Robe of the Mad Scientist", 0.03),
                        new ItemLoot("Scepter of Fulmination", 0.008)
                        ),
                    new ItemLoot("Experimental Ring", 0.04),
                    new ItemLoot("Golden Bolt", 0.04),
                    new ItemLoot("Golden Nut", 0.04),
                    new ItemLoot("The Magician Tarot Card", 0.05),
                    new TierLoot(8, ItemType.Weapon, 0.09),
     ...
     .Init("Horrific Creation",
                ...
                new MostDamagers(5,
                    ...
                    new EggLoot(EggRarity.Rare, 0.03),
        ...
        //Coward bubble
            ...
            .Init("Mad Scientist Summoner",
                new State(
                    ...
                    new State("BLAGH",
                         new ConditionalEffect(ConditionEffectIndex.Invincible),
                       new Shoot(8.4, count: 24, projectileIndex: 0, shootAngle: 30, coolDown: 5000),
                        new EntityExistsTransition("Mad Scientist Summoner", 9999, "Stop")
                        ),
                       new State("Stop",
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
