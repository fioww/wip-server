...
namespace wServer.logic
{
    partial class BehaviorDb
    {
            ...
            .Init("shtrs Bridge Sentinel",
                new State(
                    ...
                    new State("BEGIN",
                        ...
                        new Shoot(15, 15, 12, projectileIndex: 0, fixedAngle: 180, coolDown: 700, coolDownOffset: 3000),
        ...
        .Init("shtrs Loot Balloon Bridge",
                ...
                new TierLoot(12, ItemType.Armor, 0.8)
                ),
                new Threshold(0.10,
                new TierLoot(12, ItemType.Weapon, 0.6),
                new TierLoot(13, ItemType.Armor, 0.6),
                new TierLoot(6, ItemType.Ring, 0.5),
                new TierLoot(6, ItemType.Ability, 0.5)
                ),
                new Threshold(0.04,
                new ItemLoot("Frost Drake Hide Armor", 0.04),
                new ItemLoot("Frost Elementalist Robe", 0.04),
                new ItemLoot("Frost Citadel Armor", 0.04),
                new ItemLoot("Ring of Decades", 0.04)
                    )
            )
