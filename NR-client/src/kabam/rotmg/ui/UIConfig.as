...
import kabam.rotmg.ui.commands.ShowLegendaryNotificationCommand;
...
public class UIConfig implements IConfig {
    ...
    public function configure():void {
        ...
        this.commandMap.map(ShowLegendaryNotificationSignal).toCommand(ShowLegendaryNotificationCommand);
